...
exports.cheatConfig = {
    ...
    w5: {
        sailing: {
            ...
            ArtifactRarity: (t) => t / 5, // artifact rarity reduction (lower is better)
        ...
        gaming: {
            ...
            SnailStuff: (t, args) => {
                const fns = { 0: (t) => 1, 1: (t) => 0, 2: (t) => t };
                return fns[args[1]] ? fns[args[1]](t) : 0;
            },
            SnailMail: false,
            // new w7 update stuff
    ...
    w7: {
        ...
        research: {
            ...
            MagnifiersOwned: (t) => t, // ! this might cause some problems, only showing magnifiers if cheat deactive
