...
const SvgBase = (content, props = {}) => svg({
    viewBox: "0 0 24 24",
    fill: "none",
    stroke: "currentColor",
    "stroke-width": "2",
...
export const Icons = {
    ...
    Lightning: (props) => SvgBase(
        path({ d: "M13 2L3 14h9l-1 8 10-12h-9l1-8z" }),
        props),

    SearchX: (props) => SvgBase([
    ...
    ChevronRight: (props) => SvgBase(
        polyline({ points: "9 18 15 12 9 6" }),
        { "stroke-width": "2", "aria-hidden": "true", ...props }),

    ChevronLeft: (props) => SvgBase(
        polyline({ points: "15 18 9 12 15 6" }),
        { "stroke-width": "2", "aria-hidden": "true", ...props }),

    CircleSlash: (props) => SvgBase([
    ...
    Refresh: (props) => SvgBase([
        path({ d: "M23 4v6h-6" }),
        path({ d: "M20.49 15a9 9 0 1 1-2.12-9.36L23 10" })
    ], { "stroke-width": "2", "aria-hidden": "true", ...props }),

    HelpCircle: (props) => SvgBase([
        circle({ cx: "12", cy: "12", r: "10" }),
