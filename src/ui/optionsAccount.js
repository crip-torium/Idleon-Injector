...
const optionsListAccountSchema = {
    0: { name: "Player Character Count", description: "Number of characters on account", type: "number", AI: true },
    1: { name: "Chest System", description: "Controls chest functionality and storage operations", type: "number", AI: true },
    2: { name: "UI Scaling Factor", description: "Interface scaling setting for display size", type: "number", AI: true },
    3: { name: "Quick Tap Feature Toggle", description: "Enable/disable quick tap feature (1=On)", type: "number", AI: true },
    4: { name: "Quick Tap Secondary State", description: "Secondary state tracking for quick tap", type: "number", AI: true },
    5: { name: "Skill Point Allocation Amount", description: "Cycling amount (1, 5, 10, 25, 900) for skill points", type: "number", AI: true },
    6: { name: "Enhanced Skill Allocation Mode", description: "Toggle for enhanced skill point allocation interface", type: "number", AI: true },
    7: { name: "AFK Detection/Party Counter", description: "Tracks AFK detection or party member count", type: "number", AI: true },
    8: { name: "Chat Window X Position", description: "Horizontal position of chat window", type: "number", AI: true },
    9: { name: "Chat Window Y Position", description: "Vertical position of chat window", type: "number", AI: true },
    10: { name: "Chat Window Width/Columns", description: "Controls chat window width/column count", type: "number", AI: true },
    11: { name: "Chat Window Height/Rows", description: "Controls chat window height/row count", type: "number", AI: true },
    12: { name: "Chat Window Active State", description: "Chat window visibility state (-1=Inactive, 1=Active)", type: "number" },
    13: { name: "Auto-Transfer/Banking", description: "Toggle for automated banking/transfer features", type: "number", AI: true },
    14: { name: "Achievement/Quest System", description: "Tracks completion of special achievements/trophies", type: "number", AI: true },
    ...
    17: { name: "Settings Toggle", description: "General settings binary toggle", type: "number", AI: true },
    18: { name: "Chest UI Management", description: "Controls chest interface style and active element", type: "number", AI: true },
    19: { name: "Task Completion Tracking", description: "Tracks completed tasks/skills string", type: "string", AI: true },
    20: { name: "Rating/Popup System", description: "Manages rating prompts display state", type: "number", AI: true },
    21: { name: "Advanced Settings Toggle", description: "Controls advanced settings menu state", type: "number", AI: true },
    22: { name: "Chat Server Message Tracking", description: "Tracks chat-related server message states", type: "number", AI: true },
    23: { name: "Forge/Inventory Auto-Move Toggle", description: "Toggle for auto-move feature in forge/inventory (0/1)", type: "number", AI: true },
    24: { name: "Player/Character Actor Type ID", description: "Player/character actor type identifier and coordinate offset constant", type: "number", AI: true },
    ...
    30: { name: "BoltCutter Quest Progress", description: "Flag for BoltCutter secret unlock on Map 9", type: "number", AI: true },
    31: { name: "Unclaimed W2 Boss Keys Days", description: "Number of unclaimed W2 boss keys days", type: "number" },
    32: { name: "Cauldron Boost Status", description: "String flags (e.g., '0000') for 4 cauldrons (1=boost active)", type: "string", AI: true },
    33: { name: "Minigames Amount", description: "Number of minigames", type: "number" },
    34: { name: "Inventory Operation Mode", description: "Current inventory interaction mode", type: "number", AI: true },
    35: { name: "Unclaimed W2 Colosseum Ticket Days", description: "Number of unclaimed W2 colosseum ticket days", type: "number" },
    36: { name: "Player Nametag Display Toggle", description: "Controls display of player nametags (0=Enabled)", type: "number", AI: true },
    37: { name: "Guild Name", description: "Your guild name", type: "string" },
    38: { name: "Guild Icon Index", description: "Index of the selected guild icon", type: "number", AI: true },
    39: { name: "Weekly Reset Counter", description: "Tracks weekly reset cycles for shops/divinity", type: "number", AI: true },
    40: { name: "Star Sign Progress", description: "Tracks progress in star sign constellation system", type: "number", AI: true },
    41: { name: "Quest38 Item Counter", description: "Counts special items related to Quest38", type: "number", AI: true },
    42: { name: "Multiplayer Account Flag", description: "Flags accounts with multiple characters", type: "number", AI: true },
    43: { name: "Asset Management System", description: "Asset loading, compression algorithm constants, and actor type identifier", type: "number", AI: true },
    44: { name: "Bundle Expiration Timer", description: "Tracks days remaining for bundle offers", type: "number", AI: true },
    45: { name: "Bundle Cooldown Timer", description: "Tracks bundle activation status and cooldown", type: "number", AI: true },
    46: { name: "Bundle Activation Flag", description: "Indicates if a bundle offer is currently active", type: "number", AI: true },
    47: { name: "Critter Spawning Counter", description: "Tracks NONdummies array for Quest69/critters", type: "number", AI: true },
    48: { name: "Account List Display Mode", description: "Controls player list display style", type: "number", AI: true },
    49: { name: "Starter Bundle Reset", description: "Tracks starter bundle reset timing", type: "number", AI: true },
    50: { name: "Master Volume Control", description: "Overall game audio volume (0-100)", type: "number", AI: true },
    51: { name: "Music Volume Control", description: "Background music volume (0-100)", type: "number", AI: true },
    52: { name: "Effects Volume Control", description: "Sound effects volume (0-100)", type: "number", AI: true },
    53: { name: "Electron App Version", description: "Tracks Desktop/Electron app version state", type: "number", AI: true },
    54: { name: "Asset Positioning System", description: "Asset loading, sprite management, and coordinate positioning", type: "number", AI: true },
    ...
    69: { name: "Camera Positioning Actor", description: "Special camera and positioning actor type identifier", type: "number", AI: true },
    70: { name: "Recipe Points", description: "Recipe points tracking", type: "number", AI: true },
    ...
    76: { name: "Character Code L", description: "Character encoding for keyboard input (L=76)", type: "number", AI: true },
    77: { name: "Character Code M", description: "Character encoding for keyboard input (M=77)", type: "number", AI: true },
    78: { name: "Character Code N", description: "Character encoding for keyboard input (N=78)", type: "number", AI: true },
    79: { name: "Character Code O", description: "Character encoding for keyboard input (O=79)", type: "number", AI: true },
    80: { name: "Unclaimed W3 Boss Keys Days", description: "Number of unclaimed W3 boss keys days", type: "number" },
    81: { name: "Tome/Guild State", description: "Tome UI state and Guild join functionality", type: "number", AI: true },
    82: { name: "DoOnceREAL Init", description: "System initialization flag (approx -6.3)", type: "number", AI: true },
    83: { name: "Character Code S", description: "Character encoding for keyboard input (S=83)", type: "number", AI: true },
    84: { name: "Character Code T", description: "Character encoding for keyboard input (T=84)", type: "number", AI: true },
    85: { name: "Quest/Progress Limiter", description: "Quest integration and DoOnce capping logic", type: "number", AI: true },
    86: { name: "Recipe Points", description: "Recipe points (needs confirmation)", type: "number" },
    87: { name: "Character Code W", description: "Character encoding for keyboard input (W=87)", type: "number", AI: true },
    88: { name: "W4 Arena Timer", description: "World 4 arena timer", type: "number" },
    89: { name: "Character Code Y", description: "Character encoding for keyboard input (Y=89)", type: "number", AI: true },
    90: { name: "Cooking Timer", description: "Tracks cooking activity time", type: "number", AI: true },
    91: { name: "Chip Jewel System", description: "Special item crafting/spawn system", type: "number", AI: true },
    92: { name: "4-Star Cardifiers", description: "Number of 4-star cardifiers", type: "number" },
    93: { name: "Scene Event Identifier", description: "Scene event identification and positioning coordinates", type: "number", AI: true },
    94: { name: "Gem Bundle Tracker", description: "Tracks gem bundle purchases", type: "number", AI: true },
    95: { name: "Asset Management 95", description: "Asset management and positioning coordinate constant", type: "number", AI: true },
    96: { name: "Accumulated Dilapidated Slush Days", description: "Days of accumulated dilapidated slush", type: "number" },
    97: { name: "Character Code A/NUMPAD_1", description: "Character encoding for keyboard and numpad input", type: "number", AI: true },
    ...
    100: { name: "Pet Maintenance Counter", description: "Daily counter for pet food/maintenance", type: "number", AI: true },
    101: { name: "Killroy Crystals", description: "Killroy crystals (minus value)", type: "number" },
    102: { name: "Event Spawn Limiter", description: "Caps daily special event spawns (e.g. Twitch events)", type: "number", AI: true },
    103: { name: "Lava Guide / Tutorial Progression", description: "Tracks Lava tutorial/story stages (-2 to 7)", type: "number" },
    104: { name: "Tutorial UI Toggle", description: "Controls tutorial UI visibility (LavaTutStuff)", type: "number", AI: true },
    ...
    114: { name: "Talent Point System", description: "Tracks/cycles talent point rewards", type: "number", AI: true },
    115: { name: "Killroy Airhorn Reset", description: "Set to 0 to make airhorn reset available", type: "number" },
    116: { name: "Vertex Buffer Index", description: "Vertex buffer index and map identifier in rendering system", type: "number", AI: true },
    117: { name: "Boss Kill Achievement", description: "Tracks major boss kills, unlocks breeding/classes", type: "number", AI: true },
    118: { name: "Town Popup for Gemshop", description: "Controls town popup for gemshop", type: "number" },
    // 118: { name: "Limited Shop Manager", description: "Syncs limited-time shop offerings with server", type: "number" , AI: true },
    119: { name: "Story Quest Completion", description: "Tracks major story quests and world access", type: "number", AI: true },
    120: { name: "Idle Skilling Code Tracker", description: "Tracks sequential code input for rewards", type: "number", AI: true },
    121: { name: "Next Idleskilling Codes Days", description: "Days left for next idleskilling codes", type: "number" },
    122: { name: "UI Inventory Management", description: "UI inventory slot configurations and player preferences", type: "number", AI: true },
    123: { name: "Draconic Cauldrons", description: "Number of draconic cauldrons for liquid cauldrons in alchemy", type: "number" },
    124: { name: "Sailing Time Tracker", description: "Tracks sailing activity time for display", type: "number", AI: true },
    ...
    130: { name: "Skill Tree Tutorial Gate", description: "Flag for tutorial completion/skill tree unlock", type: "number", AI: true },
    131: { name: "Silver Pen Tracker", description: "Tracks accumulated silver pens from bonuses", type: "number", AI: true },
    132: { name: "Atom Collider Interface", description: "Visual state control for Atom Collider UI", type: "number", AI: true },
    133: { name: "Atom Threshold Multiplier", description: "Cycles threshold difficulty (0-3)", type: "number", AI: true },
    ...
    // 135: { name: "Bubble Particles", description: "Consumable for Atom Collider bubble upgrades", type: "number" , AI: true },
    136: { name: "UI Component Lava Message", description: "Lava message", type: "number" },
    137: { name: "Progression State Flag", description: "Controls tutorial/dungeon access state", type: "number", AI: true },
    ...
    140: { name: "Keybind: Move Up/W", description: "Keycode for upward movement", type: "number", AI: true },
    141: { name: "Keybind: Move Down/S", description: "Keycode for downward movement", type: "number", AI: true },
    142: { name: "Keybind: Move Left/A", description: "Keycode for left movement", type: "number", AI: true },
    143: { name: "Keybind: Move Right/D", description: "Keycode for right movement", type: "number", AI: true },
    144: { name: "Keybind: Action/E", description: "Keycode for action/interact", type: "number", AI: true },
    145: { name: "Keybind: Special/R", description: "Keycode for special action", type: "number", AI: true },
    146: { name: "Keybind Display: Up/W", description: "Display string for Up key", type: "string", AI: true },
    147: { name: "Keybind Display: Down/S", description: "Display string for Down key", type: "string", AI: true },
    148: { name: "Keybind Display: Left/A", description: "Display string for Left key", type: "string", AI: true },
    149: { name: "Keybind Display: Right/D", description: "Display string for Right key", type: "string", AI: true },
    150: { name: "Keybind Display: Action/E", description: "Display string for Action key", type: "string", AI: true },
    151: { name: "Keybind Display: Special/R", description: "Display string for Special key", type: "string", AI: true },
    152: { name: "Mage Kill Count", description: "Mage kill count (Wormhole skill)", type: "number" },
    153: { name: "Language Selection", description: "Selected language index (1-7)", type: "number", AI: true },
    154: { name: "95% Stamp Cost Reduction", description: "95% stamp cost reduction amount", type: "number" },
    155: { name: "Card Level Override", description: "Comma-separated Card IDs forced to level 6", type: "string", AI: true },
    156: { name: "5-Star Cardifiers", description: "Number of 5-star cardifiers", type: "number" },
    157: { name: "Player Auto-Move", description: "Toggle for player auto-movement (1=On)", type: "number", AI: true },
    158: { name: "Void Man Portals Cleared", description: "Void man portals cleared highscore (for talent calculations)", type: "number" },
    159: { name: "Sailing/Gem Init Flag", description: "One-time initialization flag (Set to 1)", type: "number", AI: true },
    ...
    165: { name: "Emporium Bonus Bribe", description: "Controls premium bribe features for fishing islands", type: "number", AI: true },
    ...
    168: { name: "Graphics Rendering Index", description: "Graphics rendering pipeline, vertex buffer operations and font rendering", type: "number", AI: true },
    ...
    171: { name: "Temp Bottle Collection", description: "Temporary bottle counter with scaling logic", type: "number", AI: true },
    ...
    182: { name: "Shimmer Trial Flag", description: "Binary flag (0/1) for trial completion", type: "number", AI: true },
    183: { name: "Weekly DPS Challenge", description: "Selector (0-21) for weekly DPS challenge", type: "number", AI: true },
    184: { name: "Fractal Isle AFK Time", description: "Fractal isle AFK time", type: "number" },
    185: { name: "WeeklyBoss Player Turn", description: "Tracks which player's turn it is in WeeklyBoss", type: "number", AI: true },
    ...
    191: { name: "WeeklyBoss Timer", description: "Weekly timer tracking for boss rotation", type: "number", AI: true },
    ...
    193: { name: "Game Progression Array", description: "Game progression array for kill tracking and advancement", type: "number", AI: true },
    194: { name: "Kill Advance Condition", description: "Condition for advancing after kills", type: "number", AI: true },
    195: { name: "Gem Drop Counter Limit", description: "Maximum limit for gem drop counters", type: "number", AI: true },
    196: { name: "UI Control & Portal Positioning", description: "UI control foundation + wisdom calculations + portal positioning + game progression tracking with graphics integration", type: "number", AI: true },
    197: { name: "Tome UI & Wisdom Card Management", description: "Tome UI control + hole wisdom card management + dual interface system with N[127] coordination", type: "number", AI: true },
    ...
    223: { name: "Tome State Flag", description: "State/quality level of Tome system", type: "number", AI: true },
    ...
    227: { name: "Skull Shop Event Flag", description: "Single-use event trigger for skull shop", type: "number", AI: true },
    228: { name: "Skull Shop Counter 1", description: "Progressive counter for skull shop reward tier 1", type: "number", AI: true },
    229: { name: "Skull Shop Counter 2", description: "Progressive counter for skull shop reward tier 2", type: "number", AI: true },
    230: { name: "Skull Shop Counter 3", description: "Progressive counter for skull shop reward tier 3", type: "number", AI: true },
    231: { name: "Ninja Floors System", description: "Tracks current floor progression in ninja system", type: "number", AI: true },
    232: { name: "Multi-System Bonus Calc", description: "Master bonus multiplier for talents/damage/drops", type: "number", AI: true },
    ...
    241: { name: "Time Tracking System", description: "Time-based achievement progress tracking", type: "number", AI: true },
    242: { name: "Hoops High Score", description: "Tracks best score in hoops game", type: "number" },
    243: { name: "Hoops State Manager", description: "Manages hoops game availability/cooldown", type: "number", AI: true },
    244: { name: "Basketball Achievement", description: "Unlocks basketball activity after level 20", type: "number", AI: true },
    245: { name: "Hoops Party Unlock", description: "Tracks party-based hoops game unlock", type: "number", AI: true },
    246: { name: "Tutorial Progress", description: "Tracks tutorial completion and milestones", type: "number", AI: true },
    247: { name: "NPC Interaction Visible", description: "Controls NPC interaction visibility", type: "number", AI: true },
    248: { name: "Mr. Pigibank Visible", description: "Controls Mr. Pigibank NPC appearance", type: "number", AI: true },
    249: { name: "UI Interaction Visible", description: "Controls UI element visibility states", type: "number", AI: true },
    250: { name: "Town_Marble Tracking", description: "Controls Town_Marble NPC and kill tracking", type: "number", AI: true },
    251: { name: "Grasslands_Gary Visible", description: "Controls Grasslands_Gary NPC appearance", type: "number", AI: true },
    ...
    // 252: { name: "Special Achievement", description: "Tracks special achievement (pet-related)", type: "number" , AI: true },
    ...
    265: { name: "Orion Complete Flag", description: "Orion system completion flag/Map 42 unlock", type: "number", AI: true },
    266: { name: "Poppy Complete Flag", description: "Poppy system completion flag/Map 73 unlock", type: "number", AI: true },
    ...
    280: { name: "Roo Progress Tracker", description: "Tracks Roo system upgrade progress", type: "number", AI: true },
    ...
    287: { name: "Roo Mode Flag", description: "Toggles normal vs Megafish mode", type: "number", AI: true },
    288: { name: "Roo Catch Progress", description: "Tracks progress toward next Roo catch", type: "number", AI: true },
    289: { name: "Roo Silver Catch Progress", description: "Tracks silver tier Roo catch progress", type: "number", AI: true },
    ...
    306: { name: "Farming Autofeeder", description: "Toggle for automated resource feeding", type: "number", AI: true },
    307: { name: "Farming Reset Flag", description: "Tracks reset state for farming upgrades", type: "number", AI: true },
    308: { name: "Voting Selection", description: "Tracks weekly community voting choice", type: "number", AI: true },
    309: { name: "Voting Week Tracker", description: "Tracks current voting week cycle", type: "number", AI: true },
    ...
    312: { name: "Villager Selection Tracking", description: "Part of Villager management system, tracks selected villager and increments selection count.", type: "number", AI: true },
    313: { name: "Villager Action Flag", description: "Set to 1 when villager actions are available; controls UI display conditions for villager interactions.", type: "number", AI: true },
    314: { name: "Coordinate/Length Value", description: "Used as X/Y coordinate for portal positioning and in monster/scene element placement calculations.", type: "number", AI: true },
    315: { name: "Daily Reset Trigger", description: "Manages time-based daily reset logic", type: "number", AI: true },
    316: { name: "Combat System Flag", description: "Generic combat state flag", type: "number", AI: true },
    317: { name: "Daily Event Counter", description: "Monitors daily event participation", type: "number", AI: true },
    ...
    322: { name: "Popup Cooldown Timer", description: "Controls gem/bundle popup display intervals", type: "number", AI: true },
    ...
    327: { name: "Quest93 Drop Prevention", description: "Flag for Quest93 drop prevention", type: "number", AI: true },
    328: { name: "Worship Totem Calculation Factor", description: "Used as a key ('_Plunderous_Kills') in the achievement system and as a division factor in worship/trial calculations (stores Meal Bonus).", type: "number", AI: true },
    ...
    337: { name: "Ribbon Shelf/Event Activation Flag", description: "Tracks Ribbon Shelf unlock status and is set to 1 when a specific server event (e.g., 'ValOn') is active.", type: "number", AI: true },
    338: { name: "Vault Knockout Progress", description: "Tracks knockout achievements for Vault upgrades", type: "number", AI: true },
    339: { name: "Tutorial Hint Dismissal Flag", description: "Tracks tutorial hints/prompts; set to 1 upon interaction to dismiss the hint UI.", type: "number", AI: true },
    340: { name: "Total Ores Mined", description: "Accumulated total ores for bonuses", type: "number", AI: true },
    341: { name: "New Character Tutorial Flag", description: "Flag for new character tutorial display", type: "number", AI: true },
    342: { name: "Gaming Mutation Mechanics", description: "Gaming mutation mechanics and probability calculations", type: "number", AI: true },
    343: { name: "Chest View Mode", description: "Toggle for chest view display mode", type: "number", AI: true },
    ...
    347: { name: "Delivery System Bonus", description: "Delivery box system tracking and bonus", type: "number", AI: true },
    348: { name: "Talent Reset Counter", description: "Tracks daily talent point resets", type: "number", AI: true },
    349: { name: "Menu Navigation State", description: "Manages multi-state menu navigation", type: "number", AI: true },
    350: { name: "Companion System Toggle", description: "Toggles companion system UI modes", type: "number", AI: true },
    351: { name: "Companion Selection Mode", description: "Controls companion selection interface", type: "number", AI: true },
    352: { name: "Quest Completion Flag", description: "One-time quest completion tracking", type: "number", AI: true },
    353: { name: "Hidden Wisdom Minigame High Score", description: "Hidden wisdom minigame high score", type: "number" },
    354: { name: "Companion Bonus Multi", description: "Companion system bonus tracker (Cap 100)", type: "number", AI: true },
    355: { name: "Rupie Slugs Purchased", description: "Number of rupie slugs purchased", type: "number" },
    356: { name: "Grimoire DMG Tracker", description: "Tracks peak Grimoire damage achieved", type: "number", AI: true },
    ...
    368: { name: "Emperor Interface State", description: "Boolean flag for emperor interface visibility", type: "number", AI: true },
    ...
    372: { name: "Achievement Progress Tracker", description: "Achievement system tracking for progression monitoring", type: "number", AI: true },
    373: { name: "Game State Achievement Flag", description: "Game state flag for achievement system", type: "number", AI: true },
    374: { name: "Achievement Unlock Condition", description: "Achievement unlock condition tracking", type: "number", AI: true },
    375: { name: "Achievement Completion State", description: "Achievement completion state monitoring", type: "number", AI: true },
    376: { name: "Achievement System Variable", description: "General achievement system variable for tracking", type: "number", AI: true },
    377: { name: "Achievement Calculation Parameter", description: "Calculation parameter used in achievement processing", type: "number", AI: true },
    378: { name: "Actor Y-Coordinate System", description: "Y-coordinate parameter in actor creation system (used in createRecycledActor)", type: "number", AI: true },
    ...
    381: { name: "Smithy 30-Day Counter", description: "Day counter for smithy time-gating", type: "number", AI: true },
    ...
    385: { name: "Treasure Hunt Event ID", description: "Tracks current treasure hunt event ID", type: "number", AI: true },
    386: { name: "Treasure Hunt Count", description: "Tracks found treasures (limit 25)", type: "number", AI: true },
    387: { name: "Windwalker Restriction", description: "Restriction flag for Windwalker class", type: "number", AI: true },
    ...
    396: { name: "Arcane Weapon Drops", description: "Tracks Arcane weapon drop progress", type: "number", AI: true },
    ...
    400: { name: "Tempest Stone Drops", description: "Tracks Tempest stone drops", type: "number", AI: true },
    401: { name: "Enable AFK Windwalker", description: "Tracks Quest 100 progress", type: "number" },
    402: { name: "Items Discovered in Sneaking", description: "resets daily - controls ability to find pristine charms/symbols", type: "number", AI: true },
    403: { name: "Sailing Progression Unlock", description: "Unlocks sailing-related feature, displays 'S' marker in UI", type: "number", AI: true },
    404: { name: "Asset Positioning Literal 404", description: "Literal numeric value used heavily in asset loading, coordinate layout, and UI element positioning (NOTE: Acts as a literal, not an array index).", type: "number", AI: true },
    405: { name: "UI State Manager 1", description: "State transitions for UI components", type: "number", AI: true },
    406: { name: "UI State Manager 2", description: "State transitions for UI components", type: "number", AI: true },
    407: { name: "UI State Manager 3", description: "State transitions for UI components", type: "number", AI: true },
    408: { name: "Kill Quest Completion", description: "Tracks specific kill quest completion", type: "number", AI: true },
    409: { name: "Quest Item Drop Tracker", description: "Accumulates quest item drops", type: "number", AI: true },
    410: { name: "Loop Reset Counter", description: "Reset during game loop", type: "number", AI: true },
    411: { name: "Gaming Mode Toggle", description: "Controls gaming/Spelunky display mode and affects sprout growth time multiplier", type: "number", AI: true },
    412: { name: "Display Mode Selector", description: "Display mode selector cycling through 3 states", type: "number", AI: true },
    413: { name: "Gaming Palette Selection", description: "Tracks selected gaming palette/tab", type: "number", AI: true },
    414: { name: "Tower Building Claims", description: "Tracks tower/workbench building claims with SuperBit bonuses", type: "number", AI: true },
    415: { name: "Acorn Shop Purchases", description: "Tracks acorn shop purchase count, affects cost calculations", type: "number", AI: true },
    ...
    417: { name: "Quest 107 Progress", description: "Tracks progress for Quest 107 (cap 50)", type: "number", AI: true },
    ...
    425: { name: "Divinity God Selection", description: "Tracks selected divinity god (1-10)", type: "number", AI: true },
    ...
    441: { name: "Timer System 2", description: "Related to countdown systems", type: "number", AI: true },
    442: { name: "Darts Minigame high score", description: "Darts minigame high score", type: "number" },
    443: { name: "Character Animation Sprite Foundation", description: "Foundation element in 447-444 resource allocation block + coordinated sprite reference system", type: "number", AI: true },
    444: { name: "Sequential Sprite References System", description: "Part of coordinated resource allocation block (447-444) + character animation foundation", type: "number", AI: true },
    445: { name: "Character Leg Animation Frames", description: "Character leg animation frames (lines 148934-148937) + part of 8-element sprite array structure (rl2, ll1, ll2)", type: "number", AI: true },
    446: { name: "Multi-Purpose Resource Identifier", description: "Sound resource ID (lines 238034, 247413) + character limb sprite reference (left hand, line 148931) + portal X-coordinate (line 262888) + mathematical lookup table (blur effects, line 267370)", type: "number", AI: true },
    447: { name: "Sound Resource ID with Audio Looping", description: "Audio system integration with looping functionality + channel-based sound management", type: "number", AI: true },
    448: { name: "Monthly Cycle Tracker", description: "Tracks monthly cycles (division by 2628000ms)", type: "number", AI: true },
    449: { name: "Unused", description: "unused index.", type: "number", AI: true },
    450: { name: "Meritocracy Voting Selection Flag", description: "Tracks selected meritocracy voting bonus from predefined bonus array", type: "number", AI: true },
    451: { name: "Meritocracy Voting Weekly Timestamp", description: "Tracks weekly timestamp for meritocracy voting", type: "number", AI: true },
    452: { name: "Quest 107 Counter", description: "Tracks Quest 107 progress", type: "number", AI: true },
    453: { name: "Meritocracy Bonus Selector", description: "Selects active meritocracy voting bonus from predefined bonus array", type: "number", AI: true },
    ...
    465: { name: "Clam Progression Counter", description: "Tracks clam upgrade system progression", type: "number", AI: true },
    466: { name: "Killroy Dialogue State", description: "Tracks Killroy dialogue sequence (1-4)", type: "number", AI: true },
    ...
    472: { name: "Voting Eligibility", description: "Determines meritocracy voting eligibility", type: "number", AI: true },
    473: { name: "Reliquarium Power Divisor", description: "Divisor in Reliquarium power calculations", type: "number", AI: true },
    474: { name: "Current Food Grade", description: "Tracks current food grade level", type: "number", AI: true },
    475: { name: "Quest106/Emporium Unlock", description: "Quest106 completion unlock that enables Emporium dialogue and golden food upgrade tier 3", type: "number", AI: true },
    ...
    478: { name: "Spelunking Progress", description: "Tracks progression in spelunking system", type: "number", AI: true },
    ...
    480: { name: "Progression Counter for Upgrades", description: "Progression counter for major upgrades (Grimoire, Compass, Legend Points) with complex calculation formulas.", type: "number", AI: true },
    481: { name: "Weekly Time Tracking System", description: "Weekly time tracking system for shop and divinity resets (week number calculations).", type: "number", AI: true },
    482: { name: "Spelunking Tutorial Completion Flag", description: "Tutorial completion flag for Spelunking tutorial system with progress tracking.", type: "number", AI: true },
    483: { name: "New Player Bundle System Flag", description: "Bundle system flag for new player rewards and premium content access.", type: "number", AI: true },
    484: { name: "Event Counter with Math Formulas", description: "Event counter with mathematical formulas for reward calculations and progression tracking.", type: "number", AI: true },
    485: { name: "Event Management Timer System", description: "Timer system for event management and talent calculations with time-sensitive mechanics.", type: "number", AI: true },
